...
def book():
    ...
    for flight_passenger in flight_passengers:
        if passenger.name==flight_passenger.name:
            return render_template("error.html", message="This person is already a passenger of this flight.")
